...
class LidarImageDataSet(object):
    """
    Dataset containing lidar point clouds and associated images.
    ...
    def __init__(self, base_filename="kitti/"):
        pass

class LidarImageData(object):
    """
    Contains a lidar pointcloud and associated image, for one time step.
    
    Attributes
    ----------
    lidar: numpy.ndarray
        Lidar pointcloud, stored as a numpy array.
    image: numpy.ndarray
        Image, stored as a numpy array.
    detections: 
    """

    def __init__(self, lidar_filename, image_filename):
        pass
